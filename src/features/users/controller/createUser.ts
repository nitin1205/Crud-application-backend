...
import { ICreateUserData, IUserDocument } from '@user/interface/user.interface';
...
export class CreateUser {
    ...
    public async create(req: Request, res: Response): Promise<void> {
        ...
        res.status(HTTP_STATUS.CREATED).json({ message: 'User successfully created' });

        
    };

    private userData(data: ICreateUserData): IUserDocument {
